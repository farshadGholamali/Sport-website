...
<div class="navbar justify-between bg-base-100 ">
  ...
  <div class="flex navbar-end gap-4">
    <a
      href="/"
      class="btn min-h-min h-10 bg-red-500 hover:bg-red-400 border-transparent hover:border-transparent rounded-[20px] shadow-lg shadow-red-500/50"
      >make a deposite
    </a>
    <button
      class="btn min-h-min h-10 px-2.5 hover:border-transparent border-blue-400 bg-blue-100 hover:bg-blue-200"
    >
      <svg
