...
export const Basketball_getStandings = readable(async (league: number, season: string, team?: number, stage?: string, group?: string) => {
    try {
...
export const Basketball_getGames = readable(async (id?:number,date?:string,league?: number, season?: string,team?:number,timezone?:string) => {
    try {
